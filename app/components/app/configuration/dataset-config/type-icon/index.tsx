...
const Icon = ({ type, size = 'lg' }: ITypeIconProps) => {
  ...
  const iconMap = {
    upload_file: (
      ...
      // </svg>
      <svg xmlns="http://www.w3.org/2000/svg" width={len} height={len} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-text-icon lucide-file-text">
